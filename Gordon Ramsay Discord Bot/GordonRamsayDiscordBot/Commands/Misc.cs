...
namespace GordonRamsayBot.Commands
{
    ...
    public class Misc : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task GordonInsult(SocketGuildUser user = null)
        {
            ...
            var iN = Utilities.GetRandomNumber(0, ArrayHandler.gInsults.Count);
        ...
        {
            var imageNum = Utilities.GetRandomNumber(0, GordonRamsayDiscordBot.Handlers.ImageHander.images.Count);
        ...
        {
            var role = Context.Guild.Roles.FirstOrDefault(x => x.Name == DesiredRole);
        ...
        {
            var cu = (SocketGuildUser)Context.User;
            ...
            else
            {
                ...
                var m = new MessageReference(msg);
